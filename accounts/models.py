...
class StudyRoom(models.Model):
    ...
    name = models.CharField(max_length=100)
    members = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='study_rooms')
    active_members = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='active_in_rooms', blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
